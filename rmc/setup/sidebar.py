...
SIDEBARS = {
	"RMC Management": {
		...
		"items": [
			...
			("RMC Profit and Loss", "Report", "RMC Profit and Loss", "rmc-invoice"),
	...
	"RMC Dashboard": {
		...
		"items": [
			...
			("Report Hub", "Page", "rmc-reports", "rmc-report"),
			("Live PLC Board", "Page", "rmc-plc-board", "rmc-plc"),
	...
	"RMC Quality": {
		...
		"items": [
			...
			("Live PLC Board", "Page", "rmc-plc-board", "rmc-plc"),
			("PLC Tags", "DocType", "RMC PLC Tag", "rmc-plc"),
			("PLC Readings", "DocType", "RMC PLC Reading", "rmc-gauge"),
			("Cube Test", "DocType", "Cube Test", "rmc-cube-test"),
